...
$d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('culin_image', $e, $f, $g));
$d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('culin_image', $e, $f, $g));
$d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('culin_image', $e, $f, $g));
