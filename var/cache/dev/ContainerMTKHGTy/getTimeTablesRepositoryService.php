...
// Returns the private 'App\Repository\TimeTablesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TimeTablesRepository.php';

return $this->privates['App\\Repository\\TimeTablesRepository'] = new \App\Repository\TimeTablesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
